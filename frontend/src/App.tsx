...
const BLOCKS: BlockDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'company_website',  label: 'Company website', type: 'url', required: true, placeholder: 'https://' },
      { id: 'demo_url',         label: 'Pick one URL that best shows what you\'re building.', hint: 'Demo, product, MVP or landing page.', type: 'url', required: false, placeholder: 'https://' },
      { id: 'industry_insight', label: 'Tell us something about your industry that big incumbents don\'t understand or ignore.', hint: '1–2 sentences. Your strongest insight revealer as a founder.', type: 'textarea', required: false, maxLength: 400 },
      { id: 'defensibility', required: false, label: 'A competitor raises $100M tomorrow to kill your startup. What\'s the one thing they can\'t buy or copy in 12 months?', type: 'textarea', maxLength: 400 },
      { id: 'third_party_dependence', required: false, label: 'Is your core product dependent on third-party APIs (OpenAI, AWS, etc.)?', type: 'boolean' },
      { id: 'third_party_explanation', required: false, label: 'Explain how and to what extent.', type: 'textarea', maxLength: 400, condition: { field: 'third_party_dependence', value: true } },
      {
        id: 'sector', required: false, label: 'Which sector(s)?', type: 'multiselect',
      ...
      { id: 'business_model',  required: false, label: 'What is your business model? Select all that apply.',  type: 'multiselect', options: ['SaaS', 'Marketplace', 'Usage-based', 'Transaction-based', 'Consulting', 'Other'] },
      { id: 'business_target', required: false, label: 'Who is your target customer? Select all that apply.', type: 'multiselect', options: ['B2C', 'B2B', 'B2B2C', 'B2G'] },
      {
        id: 'why_now_select', required: false,
      ...
      { id: 'why_now_validation', required: false, label: 'Explain that in a couple of lines.', hint: 'If you can cite the law, technology or market data that validates it, do.', type: 'textarea', maxLength: 400, condition: { field: 'why_now_select', value: 'None / general growth', operator: 'not_eq' } },
      { id: 'potential_clients', required: false, label: 'Roughly how many potential clients are in your target market?', type: 'number', placeholder: 'e.g. 50000' },
      { id: 'acv',               required: false, label: 'What is your Average Contract Value (ACV)? ($)', type: 'number', placeholder: 'e.g. 12000' },
    ],
  },
  {
    id: 'founders',
    ...
    fields: [
      ...
      { id: 'founder_1_linkedin',   required: false, label: 'Founder 1 — LinkedIn profile', type: 'url', placeholder: 'https://linkedin.com/in/...' },
      { id: 'founder_1_role',       required: false, label: 'Founder 1 — Primary role', type: 'select', options: ['Technical', 'Product', 'Commercial', 'Operations', 'Finance', 'Other'] },
      { id: 'founder_1_sector_exp', required: false, label: 'Founder 1 — Years of experience in this specific sector?', type: 'select', options: ['0–2 years', '2–5 years', '6–12 years', '12+ years'] },

      { id: 'founder_2_linkedin',   required: false, label: 'Founder 2 — LinkedIn profile', type: 'url', placeholder: 'https://linkedin.com/in/...', condition: { field: 'number_of_founders', value: ['2','3','4','4+'], operator: 'value_in' } },
      { id: 'founder_2_role',       required: false, label: 'Founder 2 — Primary role', type: 'select', options: ['Technical', 'Product', 'Commercial', 'Operations', 'Finance', 'Other'], condition: { field: 'number_of_founders', value: ['2','3','4','4+'], operator: 'value_in' } },
      { id: 'founder_2_sector_exp', required: false, label: 'Founder 2 — Years of experience in this specific sector?', type: 'select', options: ['0–2 years', '2–5 years', '6–12 years', '12+ years'], condition: { field: 'number_of_founders', value: ['2','3','4','4+'], operator: 'value_in' } },

      { id: 'founder_3_linkedin',   required: false, label: 'Founder 3 — LinkedIn profile', type: 'url', placeholder: 'https://linkedin.com/in/...', condition: { field: 'number_of_founders', value: ['3','4','4+'], operator: 'value_in' } },
      { id: 'founder_3_role',       required: false, label: 'Founder 3 — Primary role', type: 'select', options: ['Technical', 'Product', 'Commercial', 'Operations', 'Finance', 'Other'], condition: { field: 'number_of_founders', value: ['3','4','4+'], operator: 'value_in' } },
      { id: 'founder_3_sector_exp', required: false, label: 'Founder 3 — Years of experience in this specific sector?', type: 'select', options: ['0–2 years', '2–5 years', '6–12 years', '12+ years'], condition: { field: 'number_of_founders', value: ['3','4','4+'], operator: 'value_in' } },

      { id: 'founder_4_linkedin',   required: false, label: 'Founder 4 — LinkedIn profile', type: 'url', placeholder: 'https://linkedin.com/in/...', condition: { field: 'number_of_founders', value: ['4','4+'], operator: 'value_in' } },
      { id: 'founder_4_role',       required: false, label: 'Founder 4 — Primary role', type: 'select', options: ['Technical', 'Product', 'Commercial', 'Operations', 'Finance', 'Other'], condition: { field: 'number_of_founders', value: ['4','4+'], operator: 'value_in' } },
      { id: 'founder_4_sector_exp', required: false, label: 'Founder 4 — Years of experience in this specific sector?', type: 'select', options: ['0–2 years', '2–5 years', '6–12 years', '12+ years'], condition: { field: 'number_of_founders', value: ['4','4+'], operator: 'value_in' } },

      { id: 'has_technical_cofounder', required: false, label: 'Is there a technical co-founder who can build and own the product themselves?', type: 'boolean' },
      { id: 'product_builder', required: false, label: 'Who builds your core product today?', type: 'select', options: ['In-house', 'Mix', 'Primarily outsourced'] },
      {
        id: 'team_milestone', required: false,
      ...
      { id: 'team_milestone_detail', required: false, label: 'Tell us more about that milestone.', hint: 'Give us context: what did you build, what was the outcome, what did you learn?', type: 'textarea', maxLength: 600, condition: { field: 'team_milestone', value: 'First-time founder', operator: 'array_has_other' } },
    ],
  },
  {
    id: 'traction',
    ...
    fields: [
      ...
      {
        id: 'most_significant_milestone', required: false,
      ...
      { id: 'mom_growth',          required: false, label: 'Average MoM growth over the last 3 months?',           type: 'select', options: ['>20%', '10–20%', '5–10%', '<5% or N/A — building / pivoting'] },
      { id: 'net_burn',            required: false, label: 'Average monthly net burn over the last 3 months? ($)', type: 'select', options: ['< $10k', '$10k - $25k', '$25k - $50k', '$50k - $100k', '> $100k'] },
      { id: 'churn',               required: false, label: 'Average monthly churn over the last 3 months?',        type: 'select', options: ['<2%', '2–5%', '5–10%', '>10%'] },
      { id: 'acquisition_channel', required: false, label: 'How are you acquiring clients?',                       type: 'select', options: ['Clients mostly come to us — word-of-mouth, referrals, inbound, SEO', 'A mix — some inbound, but we actively chase and/or pay for the rest', 'We mostly go get them — outbound sales and paid acquisition'] },
    ],
  },
  {
    id: 'equity',
    ...
    fields: [
      ...
      { id: 'company_start_year',     required: false,  label: 'What year did the company start operating?', type: 'year', placeholder: '20XX' },
      { id: 'founding_equity',        required: false,  label: 'How much equity is held by the founding team, including the option pool?', type: 'select', options: ['>80%', '60–80%', '40–60%', '<40%'] },
      { id: 'total_raised',           required: false,  label: 'Total raised to date, excluding the current round.', hint: 'Equity, notes, SAFEs.', type: 'select', options: ['< $500k', '$500k - $1.5M', '$1.5M - $2.5M', '> $2.5M'] },
      { id: 'round_size',             required: false,  label: 'What is the total size of your current round? ($M)', hint: 'Enter in millions — e.g. 1.5 for $1.5M', type: 'number', placeholder: 'e.g. 1.5' },
      { id: 'round_committed',        required: false,  label: 'How much of the current round is already committed?', type: 'select', options: ['0–25%', '25–50%', '50–75%', '75%+'] },
      { id: 'pre_money_valuation',    required: false,  label: 'What is the pre-money valuation (or cap)? ($M)', hint: 'Enter in millions — e.g. 5 for $5M', type: 'number', placeholder: 'e.g. 5' },
      { id: 'runway',                 required: false,  label: 'What is your current runway?', type: 'select', options: ['0–2 months', '2–5 months', '6–12 months', '12+ months'] },
      { id: 'pitch_deck_url',         required: false,  label: 'Pitch deck', hint: 'Upload a PDF or paste a link (Google Drive, Dropbox, Docsend…). If password protected, share the password.', type: 'file-url', placeholder: 'https://...' },
    ],
  },
  {
    id: 'wrap',
    ...
    fields: [
      ...
      { id: 'network_contact',      required: false,  label: 'Do you know anyone in the Decelera network?', hint: 'A mentor, portfolio founder or LP.', type: 'boolean' },
      { id: 'network_contact_name', required: false,  label: 'Who is it and what\'s your relationship?', type: 'text', placeholder: 'e.g. María García — portfolio mentor', condition: { field: 'network_contact', value: true } },
      { id: 'additional_comments',  required: false,  label: 'During the 7 days at Decelera teams focus on solving their main challenge. What is your current main challenge?', type: 'textarea', maxLength: 800 },
    ],
  },
];
...
export default function App() {
  ...
  if (appState === 'complete' || appState === 'declined') {
    ...
    const rows: [string, React.ReactNode][] = [
      ...
      ['Business target',  arr(answers.business_target)],
      ['ACV',              fmt(answers.acv)],
