...
const BLOCKS: BlockDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'defensibility', required: true, label: 'A competitor raises $100M tomorrow to kill your startup. What\'s the one thing they can\'t buy or copy in 12 months?', type: 'textarea', maxLength: 400 },
      { id: 'third_party_dependence', required: true, label: 'Is your core product dependent on third-party APIs (OpenAI, AWS, etc.)?', type: 'boolean' },
      { id: 'third_party_explanation', required: true, label: 'Explain how and to what extent.', type: 'textarea', maxLength: 400, condition: { field: 'third_party_dependence', value: true } },
      {
      ...
      { id: 'business_model',  required: true, label: 'What is your business model? Select all that apply.',  type: 'multiselect', options: ['SaaS', 'Marketplace', 'Usage-based', 'Transaction-based', 'Consulting', 'Other'] },
      { id: 'business_target', required: true, label: 'Who is your target customer? Select all that apply.', type: 'multiselect', options: ['B2C', 'B2B', 'B2B2C', 'B2G'] },
      {
      ...
      { id: 'acv',               required: true, label: 'What is your Average Contract Value (ACV)? ($)', type: 'number', placeholder: 'e.g. 12000' },
    ],
  },
  {
    id: 'founders',
